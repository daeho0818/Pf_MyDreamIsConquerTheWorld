...
void cLoadingScene::Init()
{
	...
	loadScenes.push_front([&]() {SCENE->AddScene("cTitleScene", new cTitleScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cSelectStageScene", new cSelectStageScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cIceScene", new cIceScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cCityScene", new cCityScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cCityNightScene", new cCityNightScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cChurchScene", new cChurchScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cDesertScene", new cDesertScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cOceanScene", new cOceanScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cJungleScene", new cJungleScene); });
	loadScenes.push_front([&]() {SCENE->AddScene("cEndScene", new cEndScene); });
