...
void cUIManager::CenterRender(cTexture* ptr, Vec2 pos, float size, D3DXCOLOR color)
{
	D3DXMATRIXA16 mat;
	D3DXMatrixAffineTransformation2D(&mat, 1 * size, nullptr, 0, &Vec2(pos.x - (ptr->info.Width / 2) * size, pos.y - (ptr->info.Height / 2) * size));
	m_sprite->SetTransform(&mat);
	m_sprite->Draw(ptr->ptr, nullptr, nullptr, nullptr, color);
}

void cUIManager::CropRender(cTexture* ptr, Vec2 pos, RECT& rc)
{
	D3DXMATRIXA16 mat;
